...
const SECTOR_MAP: Record<string, { label: string; bg: string; color: string }> = {
  ...
  "AZM.MI":  { label: "Finance",    bg: "#EEEDFE", color: "#3C3489" },
  "BMED.MI": { label: "Finance",    bg: "#EEEDFE", color: "#3C3489" },
  "PST.MI":  { label: "Services",   bg: "#E6F1FB", color: "#0C447C" },
  "BGN.MI":  { label: "Finance",    bg: "#EEEDFE", color: "#3C3489" },
  "INW.MI":  { label: "Télécom",    bg: "#FAECE7", color: "#712B13" },
  // IBEX 35 manquants
  "TEF.MC":  { label: "Télécom",    bg: "#FAECE7", color: "#712B13" },
  "REP.MC":  { label: "Énergie",    bg: "#FAEEDA", color: "#633806" },
  "ENG.MC":  { label: "Énergie",    bg: "#FAEEDA", color: "#633806" },
  "MAP.MC":  { label: "Finance",    bg: "#EEEDFE", color: "#3C3489" },
  "AENA.MC": { label: "Services",   bg: "#E6F1FB", color: "#0C447C" },
  "MRL.MC":  { label: "Immo",       bg: "#FAEEDA", color: "#633806" },
  "CABK.MC": { label: "Finance",    bg: "#EEEDFE", color: "#3C3489" },
  "SAB.MC":  { label: "Finance",    bg: "#EEEDFE", color: "#3C3489" },
  "BKT.MC":  { label: "Finance",    bg: "#EEEDFE", color: "#3C3489" },
  "VIS.MC":  { label: "Industrie",  bg: "#E6F1FB", color: "#0C447C" },
  "MEL.MC":  { label: "Services",   bg: "#E6F1FB", color: "#0C447C" },
  // BEL 20 manquants
  "SOLB.BR": { label: "Chimie",     bg: "#E1F5EE", color: "#085041" },
  "AGS.BR":  { label: "Finance",    bg: "#EEEDFE", color: "#3C3489" },
  "UMI.BR":  { label: "Chimie",     bg: "#E1F5EE", color: "#085041" },
  "BPOST.BR":{ label: "Logistique", bg: "#FAEEDA", color: "#633806" },
  "COFB.BR": { label: "Immo",       bg: "#FAEEDA", color: "#633806" },
  "AED.BR":  { label: "Immo",       bg: "#FAEEDA", color: "#633806" },
  "COLR.BR": { label: "Distrib.",   bg: "#E1F5EE", color: "#085041" },
  "DIE.BR":  { label: "Auto",       bg: "#FAEEDA", color: "#633806" },
  "EVS.BR":  { label: "Tech",       bg: "#E6F1FB", color: "#0C447C" },
  "MELE.BR": { label: "Semi",       bg: "#E6F1FB", color: "#0C447C" },
  "ONTEX.BR":{ label: "Industrie",  bg: "#E6F1FB", color: "#0C447C" },
  "PROX.BR": { label: "Télécom",    bg: "#FAECE7", color: "#712B13" },
  "TER.BR":  { label: "Industrie",  bg: "#E6F1FB", color: "#0C447C" },
  // AEX manquants
  "PHIA.AS": { label: "Santé",      bg: "#E1F5EE", color: "#085041" },
  "ADYEN.AS":{ label: "Paiements",  bg: "#E6F1FB", color: "#0C447C" },
  "NN.AS":   { label: "Finance",    bg: "#EEEDFE", color: "#3C3489" },
  "URW.AS":  { label: "Immo",       bg: "#FAEEDA", color: "#633806" },
  "AKZA.AS": { label: "Chimie",     bg: "#E1F5EE", color: "#085041" },
  "DSM.AS":  { label: "Chimie",     bg: "#E1F5EE", color: "#085041" },
  "IMCD.AS": { label: "Chimie",     bg: "#E1F5EE", color: "#085041" },
  "BESI.AS": { label: "Semi",       bg: "#E6F1FB", color: "#0C447C" },
  "LIGHT.AS":{ label: "Tech",       bg: "#E6F1FB", color: "#0C447C" },
  "VPK.AS":  { label: "Industrie",  bg: "#E6F1FB", color: "#0C447C" },
  "OCI.AS":  { label: "Chimie",     bg: "#E1F5EE", color: "#085041" },
  // FTSE 100 manquants
  ...
  "CPG.L":   { label: "Services",   bg: "#E6F1FB", color: "#0C447C" },
  "ABF.L":   { label: "Alim.",      bg: "#E1F5EE", color: "#085041" },
  "AV.L":    { label: "Finance",    bg: "#EEEDFE", color: "#3C3489" },
  "STAN.L":  { label: "Finance",    bg: "#EEEDFE", color: "#3C3489" },
  "MNDI.L":  { label: "Industrie",  bg: "#E6F1FB", color: "#0C447C" },
  "RKT.L":   { label: "Consomm.",   bg: "#E1F5EE", color: "#085041" },
  "MNG.L":   { label: "Finance",    bg: "#EEEDFE", color: "#3C3489" },
  "INF.L":   { label: "Média",      bg: "#FAECE7", color: "#712B13" },
  // Nikkei manquants
  ...
  "6098.T":  { label: "Services",   bg: "#E6F1FB", color: "#0C447C" },
  "7751.T":  { label: "Tech",       bg: "#E6F1FB", color: "#0C447C" },
  "7832.T":  { label: "Loisirs",    bg: "#EEEDFE", color: "#3C3489" },
  "4543.T":  { label: "Santé",      bg: "#E1F5EE", color: "#085041" },
  "6594.T":  { label: "Industrie",  bg: "#E6F1FB", color: "#0C447C" },
  // S&P 500 manquants
...
export const LOGO_MAP: Record<string, string> = {
  ...
  "AZM.MI":  "azimut.it",          "BMED.MI": "bancamediolanum.it",  "PST.MI":  "posteitaliane.it",
  "BGN.MI":  "bancagenerali.it",   "INW.MI":  "inwit.it",
  // IBEX 35 supplémentaires
  "REE.MC":  "ree.es",             "GAS.MC":  "naturgy.com",         "ACS.MC":  "grupoacs.com",
  "FER.MC":  "ferrovial.com",      "CLNX.MC": "cellnex.com",
  "ENG.MC":  "enagas.es",          "MAP.MC":  "mapfre.com",          "AENA.MC": "aena.es",
  "MRL.MC":  "merlinproperties.es","CABK.MC": "caixabank.com",       "SAB.MC":  "bancsabadell.com",
  "BKT.MC":  "bankinter.com",      "VIS.MC":  "viscofan.com",        "MEL.MC":  "meliahotels.com",
  // BEL 20 supplémentaires
  "GBLB.BR": "gbl.be",             "WDP.BR":  "wdp.be",              "GLPG.BR": "galapagos.com",
  "AGS.BR":  "ageas.com",          "UMI.BR":  "umicore.com",         "BPOST.BR":"bpost.be",
  "COFB.BR": "cofinimmo.be",       "AED.BR":  "aedifica.eu",         "COLR.BR": "colruyt.be",
  "DIE.BR":  "dieteren.be",        "EVS.BR":  "evs.com",             "MELE.BR": "melexis.com",
  "ONTEX.BR":"ontexgroup.com",     "PROX.BR": "proximus.com",
  // AEX supplémentaires
  "RAND.AS": "randstad.com",       "WKL.AS":  "wolterskluwer.com",   "AH.AS":   "ah.nl",
  "NN.AS":   "nn-group.com",       "URW.AS":  "urw.com",             "AKZA.AS": "akzonobel.com",
  "DSM.AS":  "dsm.com",            "IMCD.AS": "imcdgroup.com",       "BESI.AS": "besi.com",
  "LIGHT.AS":"signify.com",        "VPK.AS":  "vopak.com",           "OCI.AS":  "oci.nl",
  // FTSE 100 supplémentaires
  ...
  "CPG.L":   "compass-group.com",  "ABF.L":   "abf.co.uk",           "AV.L":    "aviva.com",
  "STAN.L":  "sc.com",             "MNDI.L":  "mondigroup.com",      "RKT.L":   "reckitt.com",
  "MNG.L":   "mandg.com",          "INF.L":   "informa.com",
  ...
  "4523.T":  "eisai.com",
  "6098.T":  "recruit.co.jp",      "7751.T":  "canon.com",            "7832.T":  "bandainamco.com",
  "4543.T":  "terumo.com",         "6594.T":  "nidec.com",
